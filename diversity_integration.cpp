...
int main() {
    ...
    switch(sim.NUMBER_OF_BIT) {
        case 2:
            filenameTheory_1 = "4QAM_1Diversity_int.csv";
            filenameTheory_2 = "4QAM_2Diversity_int.csv";
        ...
        break;
        case 4:
            filenameTheory_1 = "16QAM_1Diversity_int.csv";
            filenameTheory_2 = "16QAM_2Diversity_int.csv";
            ofsTheory_1.open(filenameTheory_1);
            ofsTheory_2.open(filenameTheory_2);
